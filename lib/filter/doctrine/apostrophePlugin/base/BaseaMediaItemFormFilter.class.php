...
abstract class BaseaMediaItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'md5'                     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'type'                    => new sfValidatorChoice(array('required' => false, 'choices' => array('image' => 'image', 'video' => 'video', 'audio' => 'audio', 'pdf' => 'pdf', 'office' => 'office'))),
  ...
  public function addASearchDocumentsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.aMediaItemToASearchDocument aMediaItemToASearchDocument')
      ->andWhereIn('aMediaItemToASearchDocument.a_search_document_id', $values)
    ;
  }
