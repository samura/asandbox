 ...
 * @property Doctrine_Collection $aSearchDocuments
 ...
 * @method Doctrine_Collection getASearchDocuments()            Returns the current record's "aSearchDocuments" collection
 ...
 * @method aMediaItem          setMd5()                         Sets the current record's "md5" value
 ...
 * @method aMediaItem          setASearchDocuments()            Sets the current record's "aSearchDocuments" collection
...
abstract class BaseaMediaItem extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('aSearchDocument as aSearchDocuments', array(
